...
class PageController extends Controller
{
    ...
    public function RankingKeywordsProcessing($Language){
      ...
      $all_available_keywords_with_length = [];   //   Associative array that contains all keywords with length.
      $all_available_keywords_with_length_filtered_ranking = []; //Store filtered top ten keywords.
      ...
      for ($i = 1; $i <= $number_of_times_to_run; $i++) { // Loop based on number_of_times_to_run
        ...
        $key = array_search(max($all_available_keywords_with_length), $all_available_keywords_with_length);  // Get max number, then get the key of it.
        $all_available_keywords_with_length_filtered_ranking[$key] = $all_available_keywords_with_length[$key];
      ...
      foreach ($all_available_keywords_with_length_filtered_ranking as $key => $data) {  // Checking percentage
    ...
    public function RankingHateSpeechSpreadersProcessing($Language){
      ...
      $all_available_hate_speech_spreaders_with_length = [];      //   Associative array that contains all hate_speech_spreaders with length.
      $all_available_hate_speech_spreaders_with_length_filtered_ranking= [];  //Store hate_speech_spreaders top ten keywords.
      ...
      for ($i = 1; $i <= $number_of_times_to_run; $i++) { // Loop based on number_of_times_to_run
        ...
        $key = array_search(max($all_available_hate_speech_spreaders_with_length), $all_available_hate_speech_spreaders_with_length);  // Get max number, then get the key of it.
        $all_available_hate_speech_spreaders_with_length_filtered_ranking[$key] = $all_available_hate_speech_spreaders_with_length[$key];
      ...
      foreach ($all_available_hate_speech_spreaders_with_length_filtered_ranking as $key => $data) {  // Checking percentage
